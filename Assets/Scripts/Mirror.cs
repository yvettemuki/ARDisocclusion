...
public class Mirror : MonoBehaviour
{
    ...
    public void CalculateMirrorCameraPos()
    {
        ...
        Vector3 _player_cam_in_mirror = transform.InverseTransformPoint(m_CameraA.position);
        _player_cam_in_mirror.z = -_player_cam_in_mirror.z;
        Vector3 _new_mirror_cam_pos = transform.TransformPoint(_player_cam_in_mirror);
